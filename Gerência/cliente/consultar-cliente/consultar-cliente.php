...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT nome, cpf, contato, entrada FROM clientes WHERE 1";
...
echo "<tr><th>Nome</th><th>Cpf</th><th>Contato</th><th>Entrada</th><th>Remover</th></tr>";
echo "</thead>";
echo "<tbody>";
...
<head>
    ...
    <link rel="stylesheet" href="consultar-cliente.css">
...
<form action="consultar-cliente.php" method="post">
    <fieldset id="formulario1" class="">
        ...
        <button type="submit" id="btnConsultar" class="btn btn-dark mt-3">Consultar</button>
        <div id="mensagem-erro-consulta-nome" class="mensagem-erro"></div>
    </fieldset>
</form>
<form action="consultar-cliente.php" method="post">
...
<script>
    ...
    var botaoConProduto = document.getElementById('botao-con-produto');
        ...
        botaoAdCliente.addEventListener('click', function(){
            window.location.href = "../adicionar-cliente/adicionar-cliente.php";
        });
